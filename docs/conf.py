...
project = "ABM Initialization Collection"
author = importlib.metadata.metadata("abm-initialization-collection")["Author"]
copyright = f"{datetime.now().year}, {author}, Allen Institute for Cell Science"
release = importlib.metadata.version("abm-initialization-collection")
